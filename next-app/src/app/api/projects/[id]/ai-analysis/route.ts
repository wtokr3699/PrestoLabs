...
function buildFallbackAnalysis(category: string, description: string) {
  const templates: Record<string, { features: { name: string; estimatedPrice: number }[]; report: string }> = {
    website: {
      features: [
